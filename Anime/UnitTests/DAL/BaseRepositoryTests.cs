...
public class BaseRepositoryTests : IAsyncLifetime
{
    ...
    private BaseRepository<AnimeEntity> _repo = null!;
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        _repo = new BaseRepository<AnimeEntity>(_context);
    }
    ...
    {
        // Arrange
        var anime = new AnimeEntity { Id = Guid.NewGuid(), Title = "Naruto", EpisodeCount = 220 };
    ...
    public async Task GetAllAsync_ReturnsAllEntities()
    {
        ...
        var animes = Enumerable.Range(1, 5)
            .Select(i => new AnimeEntity { Id = Guid.NewGuid(), Title = $"Anime {i}" })
            .ToList();
    ...
    {
        // Arrange
        _repo.Add(new AnimeEntity { Id = Guid.NewGuid(), Title = "Naruto", EpisodeCount = 220 });
        _repo.Add(new AnimeEntity { Id = Guid.NewGuid(), Title = "Bleach", EpisodeCount = 366 });
        _repo.Add(new AnimeEntity { Id = Guid.NewGuid(), Title = "One Piece", EpisodeCount = 1000 });
        await _context.SaveChangesAsync(TestContext.Current.CancellationToken);
    ...
    {
        // Arrange
        _repo.Add(new AnimeEntity { Id = Guid.NewGuid(), Title = "Naruto" });
        await _context.SaveChangesAsync(TestContext.Current.CancellationToken);
    ...
    {
        // Arrange
        _repo.Add(new AnimeEntity { Id = Guid.NewGuid(), Title = "A" });
        _repo.Add(new AnimeEntity { Id = Guid.NewGuid(), Title = "B" });
        await _context.SaveChangesAsync(TestContext.Current.CancellationToken);
    ...
    {
        // Arrange
        _repo.Add(new AnimeEntity { Id = Guid.NewGuid(), Title = "A", EpisodeCount = 10 });
        _repo.Add(new AnimeEntity { Id = Guid.NewGuid(), Title = "B", EpisodeCount = 20 });
        _repo.Add(new AnimeEntity { Id = Guid.NewGuid(), Title = "C", EpisodeCount = 30 });
        await _context.SaveChangesAsync(TestContext.Current.CancellationToken);
    ...
    {
        // Arrange
        var anime = new AnimeEntity { Id = Guid.NewGuid(), Title = "Old Title" };
        _repo.Add(anime);
        await _context.SaveChangesAsync(TestContext.Current.CancellationToken);
    ...
    {
        // Arrange
        var anime = new AnimeEntity { Id = Guid.NewGuid(), Title = "To Delete" };
        _repo.Add(anime);
        await _context.SaveChangesAsync(TestContext.Current.CancellationToken);
    ...
    {
        // Arrange
        var anime = new AnimeEntity { Id = Guid.NewGuid(), Title = "SAO" };
        var waifu = new Waifu
        {
            Id = Guid.NewGuid(),
            Name = "Asuna",
        ...
        _context.Set<AnimeEntity>().Add(anime);
    ...
    public void AsQueryable_ReturnsQueryableOfCorrectType()
    {
        ...
        // Assert
        queryable.Should().BeAssignableTo<IQueryable<AnimeEntity>>();
    }
}
